...
public:
    ...
    Shooter(double position_x, double position_y, double vx_=100, double height=30, double width=18, double head_radius=8, Color color_=COLOR(50, 255, 100)) //change colour lol
    {
        // Shooter constructor
        color = color_;
    ...
    void set_shooter_colour(Color c)
    {
        head.setColor(c);
        head.setFill(true);
        body.setColor(c);
